...
class SignUpLocationViewControllerTests: XCTestCase {
    ...
    func setupSignUpLocationViewController() {
        ...
        sut = storyboard.instantiateViewController(withIdentifier: "SignUpLocationViewController")
            as? SignUpLocationViewController
    }
    ...
    func testSegues() {
        ...
        XCTAssertTrue(identifiers.contains("segueSignUpLocationToSignUpSize"),
                      "Segue segueSignUpLocationToSignUpSize should exist.")
    }
}
