...
class GuestLocationViewControllerTests: XCTestCase {
    ...
    func setupGuestLocationViewController() {
        ...
        sut = storyboard.instantiateViewController(withIdentifier: "GuestLocationViewController")
            as? GuestLocationViewController
    }
    ...
    func testSegues() {
        ...
        XCTAssertTrue(identifiers.contains("segueGuestLocationToGuestSize"),
                      "Segue segueGuestLocationToGuestSize should exist.")
    }
}
